...
const EmployedOffers = () => {
  ...
  useEffect(() => {
    ...
    const retrieveOffers = async () => {
      try {
        const response = await getAllEmploymentsForUser();
  ...
  return (
    <Container className='page-container'>
      <Breadcrumb>
        ...
        <Breadcrumb.Item active>Kontrakty</Breadcrumb.Item>
      </Breadcrumb>
      {!loading && offers ? (
        <OffersPageContent
